...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    { path: "/", title: "Plan Tâches", icon: "widget", type: "link", bookmark: true, active: false },
  ...
  otherRoutes: Menu[] = [
    ...
    //       type: "sub",
    //       active: false,
    //       children: [{ path: "/form/form-layout/default-form", title: "Default Forms", type: "link" }],
    //     },
    //   ],
    // },
    // {
    ...
    //       active: false,
    //       children: [
    //         { path: "https://admin.pixelstrap.com/cuba/template/basic-template.html", title: "Basic Email", type: "extTabLink" },
    //         { path: "https://admin.pixelstrap.com/cuba/template/email-header.html", title: "Basic With Header", type: "extTabLink" },
    //         { path: "https://admin.pixelstrap.com/cuba/template/template-email.html", title: "Ecommerce Template", type: "extTabLink" },
    //         { path: "https://admin.pixelstrap.com/cuba/template/template-email-2.html", title: "Email Template 2", type: "extTabLink" },
    //         { path: "https://admin.pixelstrap.com/cuba/template/ecommerce-templates.html", title: "Ecommerce Email", type: "extTabLink" },
    //         { path: "https://admin.pixelstrap.com/cuba/template/email-order-success.html", title: "Order Success", type: "extTabLink" },
    //       ],
    //     },
    //     {
    //       path: "/maintenance",
